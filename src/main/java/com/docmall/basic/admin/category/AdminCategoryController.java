...
public class AdminCategoryController {
	...
	public ResponseEntity<List<AdminCategoryVo>> getSecondCotegoryList(@PathVariable("cat_prtcode") int cat_prtcode) throws Exception {
		
		log.info("1차 카테고리:" + cat_prtcode);
